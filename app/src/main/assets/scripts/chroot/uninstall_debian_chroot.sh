...
echo "Running: am start -a android.intent.action.VIEW -d \"nativecode://callback?result=success&name=distro_uninstall_debian_chroot\""
am start -a android.intent.action.VIEW -d "nativecode://callback?result=success&name=distro_uninstall_debian_chroot" >/dev/null 2>&1
