    ...
    fun applyToTermux(context: Context) {
        try {
            ...
            val fullScript = """
                ...
                LOG_FILE="${'$'}HOME/.nativecode/x11_prefs.log"
            ...
            val cmd = "mkdir -p \$HOME/.nativecode && echo \"$scriptB64\" | base64 -d > \$HOME/.nativecode/apply_x11_prefs.sh && chmod +x \$HOME/.nativecode/apply_x11_prefs.sh && \$HOME/.nativecode/apply_x11_prefs.sh"
            
            // Send command Intent (Background execution restored)
            val intent = com.ivarna.nativecode.core.data.TermuxIntentFactory.buildRunCommandIntent(cmd, runInBackground = false)
